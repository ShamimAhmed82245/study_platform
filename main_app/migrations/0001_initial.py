# Generated by Django 5.1.4 on 2024-12-17 02:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(to='main_app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Note',
            fields=[
                ...
                ('uploaded_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.user')),
            ],
        ),
    ]
